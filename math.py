...
if (d == 0):
    c=int(input('Что вы хотите сделать с переменной? 1-модуль числа , 2-преобразование к целому числу , 3- округление , 4- квадратный корень , 5- синус угла , 6-косинус угла , 7- екпонент , 8-натуральный логарфм , 9-округление вниз , 10-округление вверх:'))  
def math1(a):
   if (c == 1 ):
